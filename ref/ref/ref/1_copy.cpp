...
void exCopy() {
	...
	// if a deep copy is needed of an object, the class will have its own implementation of the copy, copy-assignment constructor

	// to copy a collection of objects potentially needing a deep copy, you can use std::copy (ultimate in abstraction)
